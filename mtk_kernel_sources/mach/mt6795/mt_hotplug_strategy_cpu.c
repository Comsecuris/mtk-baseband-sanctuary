...
int hps_cpu_init(void)
{
    ...
    hps_ctxt.little_num_base_pnpmgr = 1;
    hps_ctxt.little_num_limit_pnpmgr = cpumask_weight(&hps_ctxt.little_cpumask);
    hps_ctxt.big_num_base_pnpmgr = 0;
    hps_ctxt.big_num_limit_pnpmgr = cpumask_weight(&hps_ctxt.big_cpumask);
#endif
