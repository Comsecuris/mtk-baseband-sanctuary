...
extern void __iomem *spm_i2c0_base;
...
#define SPM_I2C0_BASE   0x11007000	//I2C0_BASE
...
#define SPM_IRQ3_ID     190		// SLEEP_IRQ_BIT3_ID
#define SPM_IRQ4_ID     191		// SLEEP_IRQ_BIT4_ID
#define SPM_IRQ5_ID     192		// SLEEP_IRQ_BIT5_ID
#define SPM_IRQ6_ID     193		// SLEEP_IRQ_BIT6_ID
#define SPM_IRQ7_ID     194		// SLEEP_IRQ_BIT7_ID
...
#define SPM_MEMPLL_1PLL_EN	(1U << 16)
#define SPM_MEMPLL_RST_EN	(1U << 17)
...
extern u32 spm_ensure_lte_pause_interval(void);
...
#define is_ddr_high_speed(flags)	(!!((flags) & SPM_DDR_HIGH_SPEED))

#define get_high_cnt(sigsta)		((sigsta) & 0x3ff)
#define get_high_percent(sigsta)	((get_high_cnt(sigsta) * 100 + 511) / 1023)

static inline bool is_in_mem1pll_mode(void)
{
	return !!(spm_read(SPM_POWER_ON_VAL0) & (1U << 27));
}
